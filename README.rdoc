...
*** Overview
  ...
  Concept / Product Catalyst:
    In the Spring of 2015, I joined a 20-person men's doubles team and played in only 2 matches. Of the 8 scheduled, I missed 3 due to schedule conflicts and 3 because I wasn't one of the top players available for the 5 weekly matches.
...
*** Currently planned, future developments:
    ...
    - Create a step-by-step, guided process
